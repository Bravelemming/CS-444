...
#define EYE IN_4
*/
final int STEP_PAUSE = 80;
final string LEFT_LEG = "OUT_C";
final string REAR_LEG = "OUT_B";
final string RIGHT_LEG = "OUT_A";
final string EYE = "IN_4";
...
task main()
{
   ...
   triped_init();
   while (true)
   { // TO DO: IS DOWN, nNxtButtonPressed == 3, or something else!
      if (isDown() == true )
      {
